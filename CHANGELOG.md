...
- score matrices
- starting with historical initially, will then test the rest. Shoot the sheriff
...
## [0.2.0] - Initial repository structure

- Superhans got us a devcontainer
